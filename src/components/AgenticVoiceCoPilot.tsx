...
/**
 * AgenticVoiceCoPilot — AI Voice Co-Pilot for the Agentic AI Platform
 *
      ...
      dc.onopen = () => {
        ...
        setTimeout(() => {
          if (dc.readyState === "open") {
            dc.send(JSON.stringify({
              ...
              response: {
                modalities: ["audio", "text"],
                instructions: 'Greet the user. Say "Hi, I\'m your Agentic AI co-pilot. I can brief you on agent performance, anomalies, costs, workflows, and security posture. What would you like to know?" Keep it brief and professional.',
              },
            }));
          }
        }, 800);
        greetRef.current = setTimeout(() => {
          setTranscript(p => p.length === 0
            ? [{ id: `g-${Date.now()}`, role: "assistant", text: "Hi, I'm your Agentic AI co-pilot. What would you like to know?", ts: Date.now() }]
            : p);
        }, 6000);
      };
        ...
        {conn === "connected" ? (
          ...
          <>
            ...
            <div style={{ textAlign: "left" }}>
              ...
              <div style={{ fontSize: 9, fontWeight: 400, opacity: 0.7 }}>Talk to Agentic AI</div>
            </div>
          </>
        )}
      </button>
        ...
        <div style={panelStyle}>
          ...
          <div style={{ padding: "16px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                <p style={{ fontSize: 14, fontWeight: 700, color: "#fff", margin: 0, letterSpacing: "-0.01em" }}>Agentic AI Co-Pilot</p>
          ...
          <div ref={scrollRef} style={{
            ...
            {transcript.length === 0 && conn !== "connected" && (
              <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: 10 }}>
                ...
                <p style={{ fontSize: 12, color: "#3b82f6", margin: 0, fontWeight: 600 }}>Powered by Agentic AI</p>
          ...
          <p style={{ textAlign: "center", fontSize: 10, color: "#334155", paddingBottom: 12, margin: 0 }}>
            Agentic AI Platform · Voice-powered operations intelligence
          </p>
        </div>
      )}
    </>
