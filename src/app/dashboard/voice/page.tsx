  ...
  const [messages, setMessages] = useState<VoiceMessage[]>([
    {
      id: "welcome",
      role: "assistant",
      text: "Hey! I'm your voice assistant for the Agentic AI Platform. You can ask me anything about your agents, alerts, or operations. Try saying \"Hey Agent, what's the status?\" or just type your question below.",
      timestamp: new Date(),
      isVoice: false,
    },
  ]);
