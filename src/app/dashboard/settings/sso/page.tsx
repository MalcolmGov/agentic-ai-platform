...
export default function SSOSettingsPage() {
  ...
  const [samlConfig, setSamlConfig] = useState({ entityId: "https://app.swifter-ai.com/api/auth/sso/saml", acsUrl: "https://app.swifter-ai.com/api/auth/sso/callback", metadataUrl: "", certificate: "" });
